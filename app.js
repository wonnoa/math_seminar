const stages = [
  ...
  },
  {
    id: "appendix-a",
    label: "A",
    title: "Intersection, Sum, and Product of Spaces",
    page: "459",
    side: "left",
    sections: [
    ...
    type: "appendix",
    status: "bonus",
    vibe: "Optional side quest material",
  },
  {
    id: "appendix-rest",
    label: "B-F",
    title: "Additional Reference Sections",
    page: "466",
    side: "right",
    sections: [
    ...
    type: "appendix",
    status: "locked",
    vibe: "Reference archive beyond the main path",
  },
];
